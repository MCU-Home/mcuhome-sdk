...
| Sample | Demonstrates |
|---|---|
| `matter-node/` | Native composed Matter node on vanilla Zephyr: framework root-only ZAP plus two runtime-registered endpoints under the root — EP1 temperature (0x0302) and EP2 pressure (0x0305), fed by a BMP180 (upstream CHIP v1.5.1.0, nRF7002-DK). Requires the `matter` and `debug-rtt` snippets — see [matter-node/README.md](matter-node/README.md). |
