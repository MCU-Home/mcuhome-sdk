...
| Header | API |
|---|---|
| `matter_tables.h` | The generated-tables contract: the plain-C structs a builder-generated device configuration is made of. Zero CHIP types by design — this is what insulates generated code from Matter SDK churn. Versioned via `MCUHOME_MATTER_TABLES_VERSION`. |
